...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "registration.subtitle": "Ready to start your financial journey? Contact us today.",
    "registration.fullNamePlaceholder": "Enter your full name",
    "registration.emailPlaceholder": "Enter your email",
    "registration.phonePlaceholder": "Enter your phone number",
    "registration.messagePlaceholder": "Tell us about your financial goals...",
    "registration.consultation": "Financial Consultation",
    "registration.investment": "Investment Planning",
    "registration.partnership": "Partnership",
    ...
    "services.realEstateDesc": "We facilitate strategic acquisition financing for residential, commercial, and mixed-use properties. Through our strong relationships with UAE banks and international lenders, we structure tailored loan packages—ranging from short- to long-term—aligned with your investment goals.",
    "services.realEstateShortDesc": "Strategic acquisition financing for residential, commercial, and mixed-use properties with competitive terms and swift approvals.",
    "services.refinancing": "Real Estate Equity Release (Refinancing)",
    "services.refinancingDesc": "Unlock the equity in your existing real estate assets through our cash-out refinancing solutions. Ideal for developers and investors, this service allows you to extract liquidity without selling off properties. You can reinvest the funds into new ventures or use them to bolster working capital, all while benefiting from favorable financing terms and efficient execution.",
    "services.refinancingShortDesc": "Extract liquidity from your real estate assets without selling, with flexible terms and fast approvals.",
    "services.construction": "Construction & Real Estate Project Financing",
    "services.constructionDesc": "From inception to handover, we finance your construction projects—residential towers, commercial complexes, hospitality developments, and more. Drawing on relationships with top-tier lenders, we secure structured loans that support each project phase.",
    "services.constructionShortDesc": "End-to-end financing for construction projects with structured loans tailored to each phase of development.",
    "services.corporate": "Corporate Finance & Working Capital Facilities",
    "services.corporateDesc": "Supporting corporate operations across industries, we deliver comprehensive working capital and corporate loan solutions. Our expertise includes asset-backed financing, revolving credit lines, and term loans—to help businesses manage cash flows, fund growth, or make strategic investments.",
    "services.corporateShortDesc": "Comprehensive working capital and corporate loan solutions tailored to your business needs.",
    "services.acquisition": "Business Acquisition Finance",
    "services.acquisitionDesc": "Buying a business? We provide acquisition financing tailored to your specific transaction. Whether it's a management buyout, merger, or external acquisition, we structure debt based on projected cash flows, asset value, and deal specifics.",
    "services.acquisitionShortDesc": "Tailored acquisition financing for management buyouts, mergers, and external acquisitions.",
    "services.trade": "Trade Finance Facilities (LC, LG, TR, etc.)",
    "services.tradeDesc": "Facilitating international trade and commerce, we offer a broad suite of trade finance instruments—including Letters of Credit (LC), Letter of Guarantees (LG), Trade Receivables (TR), and more. These tools help manage supplier risk, optimize import/export activities, and secure funding.",
    "services.tradeShortDesc": "Comprehensive trade finance solutions including LCs, LGs, and trade receivables financing.",
    "services.restructuring": "Debt Restructuring & Settlement Solutions",
    "services.restructuringDesc": "When debts become burdensome, we step in to restructure and settle existing obligations. We work with banks and creditors to revise payment terms, consolidate loans, or negotiate reduced settlement figures. Our mission: alleviate financial strain and restore your business to stable and sustainable footing.",
    "services.restructuringShortDesc": "Expert solutions to restructure and settle existing debts with favorable terms.",
    "services.ctaTitle": "Ready to Transform Your Business Finance?",
    "services.ctaDesc": "Each service is underpinned by Blue Diamond's commitment to excellence—powered by over two decades of market expertise, deep lender relationships, and a track record of delivering swift, efficient financial solutions.",
    ...
    "blog.noPosts": "No blog posts available yet. Please check back later.",
    "blog.comingSoon": "New content coming soon!",
  ...
  ar: {
    ...
    "registration.subtitle": "مستعد لبدء رحلتك المالية؟ تواصل معنا اليوم.",
    "registration.fullNamePlaceholder": "أدخل اسمك الكامل",
    "registration.emailPlaceholder": "أدخل بريدك الإلكتروني",
    "registration.phonePlaceholder": "أدخل رقم هاتفك",
    "registration.messagePlaceholder": "أخبرنا عن أهدافك المالية...",
    "registration.consultation": "استشارة مالية",
    "registration.investment": "تخطيط الاستثمار",
    "registration.partnership": "شراكة",
    ...
    "services.realEstateDesc": "نُرتب تمويلاً متخصصًا للاستحواذ على العقارات السكنية والتجارية ومتعددة الاستخدامات. ومن خلال علاقاتنا مع البنوك المحلية والدولية، نوفر حزم تمويلية مخصصة تتناسب مع أهدافكم الاستثمارية—سواء للدخول في سوق جديد أو لتوسيع محفظتكم العقارية.",
    "services.realEstateShortDesc": "تمويل استراتيجي للاستحواذ على العقارات السكنية والتجارية بشروط تنافسية وموافقات سريعة.",
    "services.refinancing": "إعادة تمويل العقارات المملوكة (إجارة منتهية بالتمليك)",
    "services.refinancingDesc": "نُساعدكم على تحرير السيولة من أصولكم العقارية القائمة دون الحاجة إلى بيعها، عبر حلول إعادة تمويل فعالة. يمكن استخدام هذه السيولة في مشاريع جديدة أو لدعم رأس المال العامل، مع الاستفادة من شروط تمويلية مرنة وسريعة.",
    "services.refinancingShortDesc": "تحرير السيولة من الأصول العقارية دون بيعها، بشروط تمويلية مرنة وموافقات سريعة.",
    "services.construction": "تمويل المشاريع العقارية والإنشائية",
    "services.constructionDesc": "نُموّل المشاريع العقارية من البداية وحتى التسليم—بما في ذلك الأبراج السكنية، المجمعات التجارية، والمشاريع الفندقية. نعمل مع ممولين رائدين لتوفير قروض منظمة تُغطي كافة مراحل المشروع، مع التركيز على إعداد المستندات، وتدفقات النقد، وجداول الصرف.",
    "services.constructionShortDesc": "تمويل متكامل للمشاريع الإنشائية مع قروض منظمة تغطي كافة مراحل المشروع.",
    "services.corporate": "تمويل الشركات وتسهيلات رأس المال العامل",
    "services.corporateDesc": "نُقدّم حلول تمويلية متكاملة لدعم العمليات اليومية للشركات، بما في ذلك تمويل الأصول، خطوط ائتمان دوّارة، وقروض قصيرة وطويلة الأجل. تم تصميم حلولنا لتلبية احتياجاتكم التشغيلية، ودعم خطط النمو، والاستجابة للمتغيرات بسرعة وكفاءة.",
    "services.corporateShortDesc": "حلول تمويلية متكاملة لدعم عمليات الشركات واحتياجات رأس المال العامل.",
    "services.acquisition": "تمويل الاستحواذ على الأعمال",
    "services.acquisitionDesc": "سواء كنتم بصدد شراء شركة أو الاندماج معها، نُرتب تمويلًا متخصصًا يعتمد على التدفقات النقدية المتوقعة، وقيمة الأصول، وطبيعة الصفقة. هدفنا هو توفير تمويل يضمن نجاح عملية الاستحواذ من اليوم الأول.",
    "services.acquisitionShortDesc": "تمويل متخصص لعمليات الاستحواذ على الشركات والاندماج معتمداً على التدفقات النقدية وقيمة الأصول.",
    "services.trade": "تسهيلات التمويل التجاري (خطابات ضمان، اعتمادات مستندية وغيرها)",
    "services.tradeDesc": "ندعم أنشطة التجارة المحلية والدولية من خلال أدوات تمويل تجاري متنوعة، مثل خطابات الاعتماد، خطابات الضمان، وتحصيل المستحقات. هذه الأدوات تُمكّنكم من تقليل مخاطر الموردين، وتحسين عمليات الاستيراد والتصدير، وتأمين التمويل اللازم لصفقاتكم.",
    "services.tradeShortDesc": "حلول متكاملة للتمويل التجاري تشمل خطابات الضمان والاعتمادات المستندية.",
    "services.restructuring": "إعادة هيكلة الديون المتعثرة وحلول التسوية",
    "services.restructuringDesc": "عند تراكم الديون أو صعوبة السداد، نتدخل لإعادة هيكلة الالتزامات القائمة بطريقة تخفف العبء المالي. نُفاوض البنوك والدائنين لتعديل شروط السداد، أو دمج القروض، أو الوصول إلى تسويات مُخفضة تُعيد الاستقرار المالي لأعمالكم.",
    "services.restructuringShortDesc": "حلول متكاملة لإعادة هيكلة الديون وتخفيف الأعباء المالية على الشركات.",
    "services.ctaTitle": "مستعد لتحويل تمويل أعمالك؟",
    "services.ctaDesc": "جميع خدماتنا تستند إلى التزامنا بالتميز، ومعرفة عميقة بالسوق، وعلاقات قوية مع الممولين، مدعومة بخبرة تتجاوز 30 عامًا في تقديم حلول مالية فعالة وسريعة التنفيذ.",
    ...
    "blog.relatedTitle": "مقالات قد تعجبك",
    "blog.relatedDesc": "اكتشف المزيد من المقالات المفيدة حول المواضيع المالية",
    "blog.noPosts": "لا توجد مقالات متاحة حالياً. يرجى العودة لاحقاً.",
    "blog.comingSoon": "سيتم إضافة محتوى جديد قريباً!",
